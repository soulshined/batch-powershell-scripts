...
::SET IS_DEBUG TO 'TRUE' IF YOU WANT TO PAUSE AT END OF RUN TO REVIEW SCRIPT RESULTS IN CONSOLE
SET "IS_DEBUG="

:: DIR_PATH IS THE DIRECTORY/FOLDER TO MONITOR. DO NOT INCLUDE TRAILING "\"
SET DIR_PATH="D:\Your User Name\Downloads"

:: THE FOLLOWING DIRECTORIES ARE SIMPLY THE FOLDER NAME WHERE YOU WANT FOUND EXTENSION FILES TO GO
